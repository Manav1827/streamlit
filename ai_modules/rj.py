...
def add_animated_text_box(image_path, output_path, text, font_size=40, position_input="50,50", style="rainbow", font_path="arial.ttf", animation="color-cycle", text_color="white"):
